...
#include "ros/ros.h"
#include <uri_uav/tasks/localization.hpp>
...
void Localization::_activate(){
	// what do you need to do every time the task is activated?
}

void Localization::_deactivate(){
	// what do you need to do every time the task is deactivated?
}

void Localization::get_mandatory_resources(ResourceVector &res){
