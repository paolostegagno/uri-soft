...
// 			std::cout << "VIDEO NOT OPEN!! VIDEO NOT OPEN!! VIDEO NOT OPEN!! VIDEO NOT OPEN!! VIDEO NOT OPEN!!" << std::endl;
			...
			_exchange_active_backup_tmr = n->createTimer(ros::Duration(1.0/_options["framerate"]->getDoubleValue()), &VideoStream::_video_callback, this);
...
// 		
	...
	void VideoStream::_video_callback(const ros::TimerEvent&){
...
// 	bool VideoStream::get(sensor_msgs::LaserScan& scan, double timeout){
// 		
...
// 	}
	...
	PLUGINLIB_EXPORT_CLASS(uri_sensors::VideoStream, uri::Resource)
